...
You can check the contract's abi by using 'closb get code' command.)=====";
...
If you are currently using 'closb push action' command, try to add the relevant authority using -p option.)=====";
